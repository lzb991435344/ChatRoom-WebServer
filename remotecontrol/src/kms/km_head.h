...
enum client_type{C_UNKNOWN,C_CLIENT,C_MAIN,C_UPDOWNFILE,C_ADMIN,C_CMD,C_LISTEN,C_SCREEN,C_CAP_SCREEN};    //客户端是干什么来着的
...
1a   (unsigned long)WTSQuerySessionInformation
1b   (unsigned long)WTSQueryUserToken
};
*/
/*
typedef int __stdcall (*p_CloseHandle)(HANDLE hObject);
...
typedef void __stdcall (*p_WTSFreeMemory)(PVOID pMemory);
typedef BOOL __stdcall (*p_WTSQuerySessionInformation)(HANDLE hServer,DWORD SessionId,WTS_INFO_CLASS WTSInfoClass,LPTSTR* ppBuffer,DWORD* pBytesReturned);
typedef BOOL __stdcall (*p_WTSQueryUserToken)(ULONG SessionId,PHANDLE phToken);*/
...
#define k_WTSQuerySessionInformation(h1,h2,h3,h4,h5) ((p_WTSQuerySessionInformation)g_share_main->s_func.win32_func[0x1a])(h1,h2,h3,h4,h5)
#define k_WTSQueryUserToken(h1,h2) ((p_WTSQueryUserToken)g_share_main->s_func.win32_func[0x1b])(h1,h2)
/* **********************************************WIN32_END***********************************/
